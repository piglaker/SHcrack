...
flags.DEFINE_string('vis_logdir', './tf_proc/val', 'Where to write the event logs.')

flags.DEFINE_string('checkpoint_dir', './tf_proc/ckpt', 'Directory of model checkpoints.')
...
flags.DEFINE_multi_integer('vis_crop_size', [321,321],
...
flags.DEFINE_string('dataset_dir', './tf_proc/tfrecord/', 'Where the dataset reside.')
